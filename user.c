...
void InitApp(void)
{
    INTCON = 0x00;  // Deshabilitamos interrupciones
    GPIO = 0x00;    // Inicializamos puertos
    ...
    WPU = 0x00;     // Deshabilitamos las resistencias pull-up
    //IOC = 0x14;     // Habilitamos interrupciones por cambio de GP2 y GP4
    RP0 = 0x00;     // Cambiamos de banco al banco 1
    T1CON = 0x00;   // Apgamos el timer 1
}
